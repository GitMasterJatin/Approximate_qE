...
import { Settings, Play, Clock, Target, Info, Send } from 'lucide-react';

interface MainDashboardProps {
  dataSource: 'upload' | 'existing';
}

const MainDashboard: React.FC<MainDashboardProps> = ({ dataSource }) => {
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleParameterChange('maxRows', parseInt(e.target.value))}
